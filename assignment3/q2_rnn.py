...
def pad_sequences(data, max_length):
    ...
    for sentence, labels in data:
        ...
        if len(sentence) >= max_length:
            ...
            pad_sentence = sentence + [zero_vector]*(max_length - len(sentence))
            pad_labels = labels + [zero_label]*(max_length - len(sentence))
...
class RNNModel(NERModel):
    ...
    def add_embedding(self):
        ...
        embedding = tf.reshape(embedding, shape = [-1, self.max_length, self.config.n_features*self.config.embed_size])
        ### END YOUR CODE
        return embedding
    ...
    def add_prediction_op(self):
        ...
        TODO: There is quite a few things you'll need to do in this function:
